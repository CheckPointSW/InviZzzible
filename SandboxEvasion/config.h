...
namespace Config {
	...
	enum class ConfigGlobalType { CUSTOM, REGISTRY, FILE, DEVICE, PROCESS, MAC, ADAPTER, DISK, FIRMWARE, OBJECT, CPUID, WINDOW, SHARED };
	enum class ConfigGlobalEnabled { YES, NO };
	enum class ConfigCuckoo { UNBALANCED_STACK, INFINITE_DELAY, DELAYS_ACCUMULATION, FUNCTION_HOOKS, AGENT_ARTIFACTS, CUCKOOMON_CONFIGURATION, WHITELISTED_PROCESS, EVENT_NAME, RAISED_EXCEPTIONS, WMI_PROCESS, TASK_SCHED_PROCESS, PID_REUSE, AGENT_LISTENER, SUSPENDED_THREAD, DEAD_ANALYZER };
	...
	enum class ConfigVMWare { HYPERVISOR_PORT, HYPERVISOR_BIT };
	enum class ConfigGeneric { SYSTEM_UPTIME, RAM, DISK_SIZE, DRIVE_SIZE, DEVICE_NPF_NDIS, MOUSE_ACTIVE, SLEEP_DUMMY, PROCESSORS_COUNT, DNS_RESPONSE, TIME_TAMPERING };
